...
const Create = () => {
  ...
  const addStats = async () => {
    if (presence === "aanwezig") {
      ...
      await axios
        .post("https://speelplenapi.onrender.com/record/stats/add", newStat)
        .then((response) => console.log(response.data));
    }
  };
    ...
    <div style={{ height: "100vh" }}>
      <div className="container border rounded" style={{ marginTop: 20 }}>
        <p className="text-muted fw-light">
          Velden met sterren zijn
          <strong className="text-decoration-underline fw-bold pl-2">
            {" "}
            Verplicht
          </strong>
        </p>
        ...
        <form onSubmit={handleSubmit}>
          <div className="row mt-3">
            <div className="col-md-4">
              <label className="position-relative" htmlFor="surname">
                Achtenaam{" "}
            ...
            <div className="col-md-4">
              <label className="position-relative" htmlFor="name">
                Voornaam{" "}
                <i className="fa-solid fa-star text-warning star position-absolute"></i>
              </label>
              <input
            ...
            <div className="col-md-4">
              <label className="position-relative" htmlFor="dateOfBirth">
                Kind Geboortedatum
              </label>
              <input
                id="dateOfBirth"
          ...
          <div className="row mt-3">
            <div className="col-md-2">
              <label className="position-relative" htmlFor="balance">
                Saldo{" "}
                <i className="fa-solid fa-star text-warning star position-absolute"></i>
              </label>
              <input
            ...
            <div className="col-md-5">
              <label className="position-relative" htmlFor="presence">
                Aanwezigheid{" "}
                <i className="fa-solid fa-star text-warning star position-absolute"></i>
              </label>
              <select
            ...
            <div className="col-md-5">
              <label className="position-relative" htmlFor="social">
                Sociaal{" "}
                <i className="fa-solid fa-star text-warning star position-absolute"></i>
              </label>
              <select
          ...
          <div className="row mt-3 d-flex align-items-center">
            ...
            <div className="col form-check d-flex align-items-center">
              ...
              />
              <label className="check__label" htmlFor="medical">
                Medische Fiche
              </label>
            </div>
          </div>
          ...
          <div className="form-group mt-3 pb-5 edit-create-validation">
            <input
              type="submit"
